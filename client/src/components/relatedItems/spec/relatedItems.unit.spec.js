...
describe('Related Carousel', () => {
  it('should find the header Label', () => {
    const wrapper = Enzyme.shallow(<RelatedCarousel />);
...
describe('Related Card', () => {
  it('should find the header Label', () => {
    const wrapper = Enzyme.shallow(<RelatedCard info={sampleData} />);
         ...
         "name": "Forest Green & Black",
          ...
          "sale_price": null, "default?": true,
           "photos":
            ...
            "skus":
            {
              "1665053": { "quantity": 8, "size": "XS" },
              "1665054": { "quantity": 16, "size": "S" },
              "1665055": { "quantity": 17, "size": "M" },
              "1665056": { "quantity": 10, "size": "L" },
              "1665057": { "quantity": 15, "size": "XL" },
              "1665058": { "quantity": 4, "size": "XL" }
            }
          },
          {
            "style_id": 286895,
